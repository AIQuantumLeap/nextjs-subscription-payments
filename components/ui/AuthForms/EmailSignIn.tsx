  ...
  return (
    <div className="space-y-4">
      ...
      <form noValidate onSubmit={handleSubmit} className="space-y-3">
        ...
        >
          {isSubmitting ? <><LoadingDots /> Sending…</> : 'Send Magic Link'}
        </button>
      </form>
      ...
      {allowPassword && (
        <p className="text-center text-sm text-zinc-500 pt-2 border-t border-zinc-800">
          ...
          {' · '}
          <Link href="/signin/signup" className="text-zinc-200 hover:text-white transition-colors underline underline-offset-2">
            Create account
          </Link>
        </p>
      )}
